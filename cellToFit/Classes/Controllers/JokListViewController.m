...
- (void)createTableView
{
    ...
    [self.tableView registerClass:[JokCell class] forCellReuseIdentifier:@"Cell"];
...
{
    return [tableView fd_heightForCellWithIdentifier:@"Cell" configuration:^(JokCell *cell) {
